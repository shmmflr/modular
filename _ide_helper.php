 ...
 */
     ...
     */
         ...
         *
         * @return \Shofo\User\Models\User|null
         * @static
         */
         ...
         *
         * @param mixed $id
         * @return \Shofo\User\Models\User|false
         * @static
         */
     ...
     */
        ...
        public static function to($path, $status = 302, $headers = [], $secure = null)
        {
                    ...
                    /**
         * Create a new redirect response to an external URL (no validation.php).
         *
         * @param string $path
         * @param int $status
         * @param array $headers
...
')
     ...
     */
        ...
        public static function setPresenceVerifier($presenceVerifier)
        {
                    ...
                    /**
         * Get the container instance used by the validation.php factory.
         *
        ...
        public static function getContainer()
        {
                    ...
                    /**
         * Set the container instance used by the validation.php factory.
         *
         * @param \Illuminate\Contracts\Container\Container $container
